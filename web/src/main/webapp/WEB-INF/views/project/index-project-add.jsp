                ...
                <form class="form-horizontal" action="${website}/project/addProject" method="post"  enctype="multipart/form-data">
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="name" required="required"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="eee">时间</label>
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="date" required="required"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">备注</label>
                            <div class="controls">
                                <input type="text" class="input-xlarge" name="notes" required="required"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="">介绍</label>
                            <div class="controls">
                                <textarea type="text" class="input-xlarge" id="role"  name="content" required="required"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <p style="margin-left: 20%;margin-top: 20px;"><input type="submit" value="确认添加"><a class="btn" href="${website}project/tolistAll">取消</a></p>
                    </fieldset>
                </form>
          	</div>
          </div>
