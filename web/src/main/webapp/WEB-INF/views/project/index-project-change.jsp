          ...
          <div class="row-fluid">
          	...
          	<div class="container-fluid">
          		...
          		<fieldset>
                    ...
                    <p style="margin-left: 20%;margin-top: 20px;"><a class="btn" href="index-project.html">确认修改</a><a class="btn" href="index-project.html">取消</a><a class="btn" href="index-project.html">删除项目</a></p>        
                </fieldset>
          	    </form>
          	</div>
          </div>
