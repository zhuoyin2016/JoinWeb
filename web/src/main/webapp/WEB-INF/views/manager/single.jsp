    ...
    <div class="row-fluid">
        ...
        <div class="span9">
            <div class="row-fluid">
                ...
                <form class="form-horizontal" action="${website}man/single" method="post">
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="role">用户名</label>
                            <div class="controls">
                                <input name="username" type="text" class="input-xlarge" id="role" value="${currentManager.currentUsername}"/>
                            </div>
                        </div>
                        <div class="control-group">
