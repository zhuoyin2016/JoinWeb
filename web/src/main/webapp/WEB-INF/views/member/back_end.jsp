...
<div class="page">
    ...
    <div class="show">
        ...
        <%--先显示后端负责人，然后是在后端部门并担任主任、副主任职务的，最后是按年级2014、15、16、17顺序遍历成员--%>
        <ul>
            <c:forEach items="${memberList}" var="memberList" varStatus="status">
                ...
                <c:if test="${memberList.visible=='1'}">
                    ...
                    <c:if test="${memberList.position=='3'}">
                        <li>
                            <img src="../../../image/memberImage/${memberList.memberPhoto}" alt="后端负责人">
                            <div class="tip">
                                <p class="front" id="big">后端负责人</p>
                                <p class="after">
        ...
        <%--成员全部信息展示，先显示后端负责人，成员显示顺序按照 在后端部门并担任主任、副主任职务的，最后是按年级2014、15、16、17顺序遍历成员--%>
