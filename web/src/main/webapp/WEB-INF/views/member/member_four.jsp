                ...
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"><a class="big-li-of-a">部门成员</a>
                                <ul class="level2_1">
    ...
    <div class="row-fluid">
            ...
            <div class="well sidebar-nav">
                <ul class="nav nav-list">
                    <li class="nav-header"><i class="icon-wrench"></i>人员</li>
                        <ul class="level2_1">
                            <li><a class="small-li-of-a" href="${website}man/all">管理员</a></li>
                        </ul>
                    </li>
        ...
        <div class="span9">
            <div class="row-fluid">
                ...
                <table class="table table-striped table-bordered table-condensed" style="align-content: center">
                    <thead>
                    <tr>
                        <th>头像</th>
                        <th>姓名</th>
